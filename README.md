...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-14 12:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b0b83f87-a0fc-4499-bdb8-8e04c4b4f536.git
$ cd b0b83f87-a0fc-4499-bdb8-8e04c4b4f536
```
